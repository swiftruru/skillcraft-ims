...
- **批次操作**：多選商品，浮動操作列支援「批次調整分類」、「批次調整售價 / 進價」與「批次刪除」（有庫存的商品自動略過）
...
- **訂單詳情**：彈窗顯示品項明細與金額，底部水平時間軸呈現訂單生命週期；已收貨且未付款時顯示「標記已付款」按鈕
- **PDF 列印**：美化採購單，含公司標頭、品項表格、簽名欄
- **供應商詳情**：點擊供應商名稱開啟 Dialog，顯示聯絡資訊、信用額度進度條、採購統計與完整訂單歷史
...
- **客戶詳情**：點擊客戶名稱開啟 Dialog，顯示聯絡資訊、信用額度進度條、消費統計與訂單歷史
